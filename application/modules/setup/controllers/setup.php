...
class Setup extends MX_Controller {
    ...
    public function __construct()
    {
        ...
        if (!$this->session->userdata('mcs_lang'))
        {
            $this->session->set_userdata('mcs_lang', 'english');
        }

        $this->lang->load('mcs', $this->session->userdata('mcs_lang'));
    }
    ...
    public function language()
    {
        ...
        {
            $this->session->set_userdata('mcs_lang', $this->input->post('mcs_lang'));
    ...
    public function create_user()
    {
        ...
        $this->load->model('user/mdl_users');

	...
	<div class="col-md-12">	
		...
		<address>  
			...
			if($info->role_id == $this->admin_role_id){
				...
				echo 'Access patient module.';	

			}else{

				if($this->Role->get_all_permited($info->role_id, 'view', $this->client_id)->num_rows() > 0){
					echo '<ul class="list-unstyled">';
					foreach($this->Role->get_all_permited($info->role_id, 'view', $this->client_id)->result_array() as $modules){
						echo '<li>'.ucfirst($modules['section']).'</li>';
					}
					echo '</ul>';
				}
				else

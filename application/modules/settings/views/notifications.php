				...
				<div role="content">
					...
					<div class="widget-body">
						...
						<ul id="settingsTab" class="nav nav-tabs bordered">
							...
							<li class="active" id="notifications">
						...
						<div id="settingsTabContent" class="tab-content padding-10">
							<div class="tab-pane fade in active" id="s4">
								...
								<?php echo form_open('settings/doUpdateNotification/','class="smart-form" id="notifications-form"');?>
									<section>
									...
									<button type="submit" id="submit" class="btn btn-primary btn-sm">Update notifications</button>
								</form>
							</div>
						</div>

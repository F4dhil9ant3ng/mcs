					...
					<div class="widget-body">
						...
						<div id="myTabContent1" class="tab-content padding-10">
							<div class="tab-pane fade in active" id="general-tab">
								<?php echo form_open_multipart('settings/general_update/',array('id'=>'general_udate','class'=>'smart-form', 'role'=>'form'));?>
								
								<legend><?php echo $this->lang->line("setting_general_configuration"); ?></legend>
								<fieldset>	
									<?php if($this->config->item('company_logo')) { 
									echo '<img src="'. base_url().'/uploads/'.$this->client_id.'/logo/'.$this->config->item('company_logo').'" />';
									} ?>
									<section>

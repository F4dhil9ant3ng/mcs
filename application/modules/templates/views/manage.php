		...
		*/	
		...
		/* BASIC ;*/
			...
			$('#table-templates').dataTable({
		        ...
		        "ajax": {
		            url: BASE_URL + 'templates/load_ajax/',
		            type: 'POST',
		        },
				"oLanguage": {
				...
				"preDrawCallback" : function() {
					...
					if (!responsiveHelper_dt_basic) {
						responsiveHelper_dt_basic = new ResponsiveDatatablesHelper($('#table-templates'), breakpointDefinition);
					}
				},
				...
				"drawCallback" : function(oSettings) {
					...
					$('#table-templates').find('td:first').css('width', '30%');
					$('#table-templates').css('width', '100%');
		        ...
		        "pageLength": 10,
		        //{"id":"1","name":"Default RX Pad","type":"rxpad","status":"1","created":"2017-04-05 22:01:52"}
		        aoColumns: [
		            {mData: 'id'},   
		            {mData: 'name'},         
		            {mData: 'type'},

					...
					<div class="row">
						...
						<div class="col-xs-3 col-sm-7 col-md-7 col-lg-7 text-right">
							...
							<?php if(($this->admin_role_id != $this->role_id) ? $this->Role->has_permission('users', $this->role_id, 'create',  $this->client_id) : true) { ?>
								<a href="<?php echo site_url('user/view/-1/');?>" data-original-title="<?php echo $this->lang->line('__common_create_new');?>" class="preview btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;<span class="hidden-mobile"><?php echo $this->lang->line('__common_create');?></span> </a>

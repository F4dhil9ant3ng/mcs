			...
			switch ($custom_field->custom_field_type) {
				...
				<?php break;
					...
					<section>
						<label for="custom_field_label"><?php echo $custom_field->custom_field_label; ?></label>
						<label class="select">
							<select class="<?php if($custom_field->custom_field_is_required == 1) echo 'is_required';?>" name="custom[<?php echo $custom_field->custom_field_column; ?>]" id="<?php echo $custom_field->custom_field_column; ?>" >
				...
				<?php break;
					...
					<section>
						...
						<div class="input input-file">
							<span class="button"><input type="file" class="<?php if($custom_field->custom_field_is_required == 1) echo 'is_required';?>" id="<?php echo $custom_field->custom_field_column; ?>" name="custom[<?php echo $custom_field->custom_field_column; ?>]" onchange="this.parentNode.nextSibling.value = this.value">Browse</span><input type="text" readonly="">
						</div>
					</section>
				<?php break;
					case "date": ?>

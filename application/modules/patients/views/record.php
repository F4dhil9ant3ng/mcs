...
<div id="patient-profile">
	<div id="patient-profile-details">
		...
		<div id="action">
			<?php if(!$this->Queing->exists($info->id, $this->client_id)){ ?>
		...
		<span><?php if($this->Queing->exists($info->id, $this->client_id)){ echo 'QUE # : '. $this->Queing->get_info($info->id, $this->client_id)->que_id.'</span>'; }?>
